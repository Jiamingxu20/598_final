...
class PushLEnv(gym.Env):
    ...
    #     TeleopAgent = collections.namedtuple('TeleopAgent', ['act'])
    #     if select == 0:
    #         device0 = SpaceMouse(pos_sensitivity=5000.0, rot_sensitivity=5000.0, SpaceMouseNumber=0)
    #     else:
    #         device0 = SpaceMouse(pos_sensitivity=5000.0, rot_sensitivity=5000.0, SpaceMouseNumber=1)
