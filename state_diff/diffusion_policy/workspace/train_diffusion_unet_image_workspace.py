...
from diffusion_policy.policy.diffusion_traj_unet_image_policy import DiffusionTrajUnetImagePolicy
...
class TrainDiffusionUnetImageWorkspace(BaseWorkspace):
    ...
    def __init__(self, cfg: OmegaConf, output_dir=None):
        ...
        if 'traj' in cfg.policy._target_:
            self.model: DiffusionTrajUnetImagePolicy = hydra.utils.instantiate(cfg.policy)
            self.ema_model: DiffusionTrajUnetImagePolicy = None
        else:
        ...
        with JsonLogger(log_path) as json_logger:
            for local_epoch_idx in range(cfg.training.num_epochs):
                ...
                if cfg.training.freeze_encoder:
                    underlying_model.obs_encoder.eval()
                    underlying_model.obs_encoder.requires_grad_(False)
