...
from diffusion_policy.env.pusht.pushl_image_env import PushLImageEnv
...
class PushImageRunner(BaseImageRunner):
    def __init__(self,
            output_dir,
            n_train=10,
            n_train_vis=3,
        ...
        env_type = kwargs.get('env_type', 'pushl_traj_image')
        if env_type == 'pusht_image' :
            ImageEnv = PushTImageEnv
        elif env_type == 'pushl_traj_image' or env_type == 'pushl_image' or env_type == 'pushl_two_traj_image':
            ImageEnv = PushLImageEnv
