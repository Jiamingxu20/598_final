...
from diffusion_policy.env.pusht.pushut_keypoints_env import PushUTKeypointsEnv
...
class PushUTKeypointsRunner(BaseLowdimRunner):
    def __init__(self,
            output_dir,
        ...
        kp_kwargs = PushUTKeypointsEnv.genenerate_keypoint_manager_params()
            ...
            return MultiStepWrapper(
                VideoRecordingWrapper(
                    PushUTKeypointsEnv(
                        ...
                        obs_key=kwargs.get('obs_key', 'keypoint'),
                        state_key=kwargs.get('state_key', 'state'),
    ...
    def run(self, policy: BaseLowdimPolicy):
        ...
        for chunk_idx in range(n_chunks):
            ...
            pbar = tqdm.tqdm(total=self.max_steps, desc=f"Eval PushutKeypointsRunner {chunk_idx+1}/{n_chunks}", 
