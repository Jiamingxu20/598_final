...
class DiffusionTrajUnet3dHybridImagePolicy(BaseImagePolicy):
    def __init__(self, 
            shape_meta: dict,
        ...
        self.inv_guided_encoder = kwargs.get('inv_guided_encoder', True)
    ...
    def predict_action(self, obs_dict: Dict[str, torch.Tensor]) -> Dict[str, torch.Tensor]:
        ...
        if self.obs_as_global_cond:
            ...
            cond_data[:,:To,:] = nobs_features.reshape(B, To, -1)
            cond_mask[:,:To,:] = True
    ...
    def compute_loss(self, batch):
        ...
        if self.training_stage == 0:
            ...
            # trajectory: (B, 1, T, S, 1), global_cond: (B, S*T_s)
