...
class DiffusionTrajUnetVaePcdPolicy(BaseImagePolicy):
    def __init__(self, 
            shape_meta: dict,
        ...
        self.vae = VAE(
            ...
            latent_dim=kwargs.get('vae_latent_dim', 64),
            device='cpu',
            encoder_kwargs=encoder_kwargs,
        )
        # encoder = ObservationGroupEncoder(
        ...
        obs_feature_dim = kwargs.get('vae_latent_dim', 64)  # obs_encoder.output_shape()[0]
