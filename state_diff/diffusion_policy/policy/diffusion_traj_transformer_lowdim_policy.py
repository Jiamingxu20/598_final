...
from diffusion_policy.model.common.losses import normal_kl, discretized_gaussian_log_likelihood
...
from diffusion_policy.policy.base_lowdim_policy import apply_conditioning_init

class DiffusionTrajTransformerLowdimPolicy(BaseLowdimPolicy):
    def __init__(self, 
        ...
        self.mask_generator = LowdimMaskGenerator(
            output_dim=obs_dim,
            obs_dim=0 if (obs_as_cond or self.obs_as_impainting) else obs_dim,
    ...
    def get_optimizer(
        ...
        optim_groups.append({
            ...
            "weight_decay": inv_model_weight_decay
        })
    ...
    def compute_loss(self, batch, action_slice=None):
        ...
        pred = self.model(noisy_obs, timesteps, cond)
