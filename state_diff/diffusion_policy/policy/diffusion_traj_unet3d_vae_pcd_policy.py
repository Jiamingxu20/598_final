...
class DiffusionTrajUnet3dVaePcdPolicy(BaseImagePolicy):
    def __init__(self, 
            shape_meta: dict,
        ...
        vae_latent_dim = kwargs.get('vae_latent_dim', 64)
        self.vae = VAE(
    ...
    def compute_loss(self, batch):
        ...
        if self.training_stage == 0:
            ...
            # Calculating inv loss
            # Transform to shape (batch, channel=1, horizon=16, H=32, W=1)
